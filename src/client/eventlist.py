...
CONNECTIONLAYER_WRONGROOMID_ID = "connection_layer.wrong_room_id.event.id"
CONNECTIONLAYER_UNEXPECTEDERROR_ID = "connection_layer.unexected_error.event.id"

BOARDGUILAYER_MOVEMADE_ID = "board_gui_layer.move_made.event.id"

OPENROOMGUILAYER_OPENROOM_ID = "open_room_gui_layer.open_room.event.id"
OPENROOMGUILAYER_TRANSBOARDGUI_ID = "open_room_gui_layer.trans_board_gui.event.id"
OPENROOMGUILAYER_TRANSLOBBY_ID = "open_room_gui_layer.trans_lobby.event.id"
